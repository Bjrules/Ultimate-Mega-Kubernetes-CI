pipeline {
    agent any
    // when ever a tool is installed via plugin in jenkins then it has to be configured in: Manage jenkins>tools menu 
    ...
    always {
        script {
            ...
            emailext (
                ...
                body: body,
                to: 'justbj@live.com',
                from: 'jenkins@bbwestern.com',
                replyTo: 'jenkins@bbwestern.com',
                mimeType: 'text/html',
